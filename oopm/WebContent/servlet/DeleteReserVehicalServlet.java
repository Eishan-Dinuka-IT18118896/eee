...
/**
 * Servlet implementation class DeleteReserVehicalServlet
 */

@WebServlet("/DeleteReserVehicalServlet")
public class DeleteReserVehicalServlet extends HttpServlet 
{
     ...
     */
    public DeleteReserVehicalServlet() {
        super();
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException 
	{
		...
		iReserveService.removeReserveVehical(reservationID);
